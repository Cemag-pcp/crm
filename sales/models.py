...
class PortalUser(models.Model):
    ...
    email = models.EmailField(blank=True)
    phone = models.CharField(max_length=20, blank=True, help_text="Telefone com DDD, ex: (85) 99999-9999")
    whatsapp = models.CharField(max_length=20, blank=True, help_text="Número com DDI e DDD, ex: 5511999999999")
